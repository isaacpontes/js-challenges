/**
 * Creates an equantion object in the format ax² + bx + c = 0
 */
class Equation {
...
const eq4 = new Equation(0, -12, 9) // [ 0.75 ]
const eq5 = new Equation(1, -5, 2)  // []
const eq6 = new Equation(1, -2, 1)  // [ 1 ]
const eq7 = new Equation(1, -4, -5) // [ 5, -1 ]
const eq8 = new Equation(-2, 1, -6)  // [ 1.5, -2 ]
...
console.log(eq6.getRoots())
console.log(eq7.getRoots())
console.log(eq8.getRoots())